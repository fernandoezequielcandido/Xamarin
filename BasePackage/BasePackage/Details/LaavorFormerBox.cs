...
{
    /// <summary>
    /// Class LaavorFormerBox
    /// </summary>
    public class LaavorFormerBox : Frame
    {
        /// <summary>
        /// Set Touch
        /// </summary>
        ...
        /// <summary>
        /// Constructor LaavorFormerBox
        /// </summary>
        public LaavorFormerBox()
        {
        ...
        public static readonly BindableProperty VivacityProperty = BindableProperty.Create(
                 ...
                 declaringType: typeof(LaavorFormerBox),
        ...
        {
            LaavorFormerBox laavorBox = (LaavorFormerBox)bindable;
            laavorBox.VivacityPropertyChanged();
        }
        ...
        {
            LaavorFormerBox laavorBaseBox = (LaavorFormerBox)bindable;
            if (!laavorBaseBox.ReadOnly)
            {
                laavorBaseBox.VivacityPropertyChanged();
            }
        }
