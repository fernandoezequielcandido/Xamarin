...
namespace LaavorIconButtonFit
{
    /// <summary>
    /// Class IconButtonFit
    /// </summary>
    public class IconButtonFit : StackLayout
    {
        /// <summary>
        ...
        private IconButtonImageFit imageButton;
        ...
        /// <summary>
        /// Constructor of IconButtonFit
        /// </summary>
        public IconButtonFit()
        {
        ...
        {
            imageButton = new IconButtonImageFit("__Laavor*+-///qwertyuiiii23444UUUU+=@33%%*&¨VVVMMad13,a,a8d939kl", currentIconType, currentColorUI);
        ...
        /// <summary>
        /// Property to report if IconButtonFit is readonly.
        /// </summary>
        public static readonly BindableProperty IsReadOnlyProperty = BindableProperty.Create(
                 propertyName: nameof(IsReadOnly),
                 returnType: typeof(bool),
                 declaringType: typeof(IconButtonFit),
                 defaultValue: false,
        ...
        {
            IconButtonFit iconButtonFit = (IconButtonFit)bindable;
            bool copyIsReadOnly = (bool)newValue;
            if (copyIsReadOnly)
            {
                iconButtonFit.imageButton.GestureRecognizers.Clear();

                iconButtonFit.imageButton.Opacity = 0.3;
            }
            else
            {
                if (iconButtonFit.UseClickEffect || iconButtonFit.UseTouchEffect)
                {
                    iconButtonFit.imageButton.GestureRecognizers.Add(iconButtonFit.GetVivacity());
                }

                iconButtonFit.imageButton.GestureRecognizers.Add(iconButtonFit.GetTouch());

                iconButtonFit.imageButton.Opacity = 1.0;
            }
        }
        ...
        private static void HeightPropertyChanged(object bindable, object oldValue, object newValue)
        {
            ...
            iconButtonFit.imageButton.HeightRequest = buttonHeight;
        }
        ...
        private static void WidthPropertyChanged(object bindable, object oldValue, object newValue)
        {
            ...
            iconButtonFit.imageButton.WidthRequest = buttonWidth;
        }
