...
{
    /// <summary>
    /// Class InputAutoImage
    /// </summary>
    public class InputAutoImage: StackLayout
    {
        private Entry entry;
        ...
        private InputImageBox image = null;
        ...
        private ColorUI currentColorIcon = ColorUI.Black;
        private IconType currentIconType = IconType.Pencil;
        ...
        /// <summary>
        /// Constructor of InputAutoImage
        /// </summary>
        public InputAutoImage() : base()
        {
            InitAll();
        }
        ...
        private void InitAll()
        {
            ...
            image = new InputImageBox("hashlaavorForceIsImpossibile98743987238497**/+-ppçLLkJJ", currentIconType, currentColorIcon);
        ...
        public static BindableProperty TextProperty = BindableProperty.Create(
           ...
           declaringType: typeof(InputAutoImage),
           defaultValue: "",
        ...
        {
            InputAutoImage inputImage = (InputAutoImage)bindable;
            string text = (string)newValue;           
            inputImage.Text = text;
        }

        /// <summary>
        /// Gets or sets the placeholder text shown when the entry InputAutoImage.Text is null or empty.
        /// </summary>
        ...
        private void SidePropertyChanged()
        {
            ...
            if (currentSide == Side.Left)
            {
                ...
                stackGroupItems.Children.Add(stackEntry);
                image.HorizontalOptions = LayoutOptions.Start;
                entry.Margin = new Thickness(-10, -10, -10, -20);
                image.Margin = new Thickness(-10, -10, 10, -20);
            }
            else
            {
        ...
        /// <summary>
        /// Set if is Color Icon
        /// </summary>
        [Bindable(true)]
        public ColorUI ColorIcon
        {
            get
            {
                return currentColorIcon;
            }
            set
            {
                currentColorIcon = value;
                ColorUIIconPropertyChanged();
            }
        }

        private void ColorUIIconPropertyChanged()
        {
            image.ChangeColor("hashlaavorForceIsImpossibile98743987238497**/+-ppçLLkJJ", currentColorIcon);
        }
        ...
        {
            image.ChangeIcon("hashlaavorForceIsImpossibile98743987238497**/+-ppçLLkJJ", currentIconType);
        }
