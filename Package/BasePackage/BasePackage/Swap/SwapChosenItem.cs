namespace Laavor
{
    ...
    {
        /// <summary>
        /// Class SwapChosenItem
        /// </summary>
        public class SwapChosenItem
        {
            /// <summary>
            /// Internal
            /// </summary>
            ...
            /// <param name="valueImage"></param>
            /// <param name="source"></param>
            public SwapChosenItem(string hash, int indexImage, int numberContent, string valueContent, string valueImage, string source)
            {
                if (hash == "__Laavor*+-")
                {
                    this.IndexImage = indexImage;
